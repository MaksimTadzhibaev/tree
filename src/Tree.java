...
public class Tree {
    ...
    private class NodeAndParent {
        ...
        public NodeAndParent(Node current, Node parent) {
            this(current, parent, 0);
        }

        public NodeAndParent(Node current, Node previous, int currentLevel) {
    ...
    public boolean add(int value) {
        ...
        Node previous = nodeAndParent.parent;
    ...
    public Node findNodeByValue(int value) { // поиск узла по значению
        ...
        return new Node(level); // возвращаем найденный элемент
    }
